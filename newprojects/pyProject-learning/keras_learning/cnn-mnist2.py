...
# 选取6个特征卷积核，大小为5∗5(不包含偏置),得到6个特征图，每个特征图的大小为28−5+1=24
# 也就是神经元的个数由10241024减小到了24∗24=156
# 输入层与C1层之间的参数:6∗(5∗5+1)
model.add(Conv2D(6, kernel_size=(5, 5), activation='relu', input_shape=(28, 28, 1)))
# 这一层的输入为第一层的输出，24*24*6的节点矩阵。
# 本层采用的过滤器大小为2*2，长和宽的步长均为2，所以本层的输出矩阵大小为12*12*6。
