...
from data_process import load_data_from_csv, seg_words,get_char
...
if __name__ == '__main__':
    ...
    content_train = get_char(content_train)
    ...
    content_validate = get_char(content_validate)
